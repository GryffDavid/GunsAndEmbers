...
namespace TowerDefensePrototype
{
    public class Emitter
    {
        ...
        public bool Active, Fade, CanBounce, AddMore, Shrink, StopBounce;
        ...
        public Emitter(String textureName, Vector2 position, Vector2 angleRange, Vector2 speedRange, Vector2 hpRange, 
            ...
            Vector2 yrange, bool? shrink = null, float? drawDepth = null, bool? stopBounce = null)
        {
            Active = true;
                ...
                if (Burst < 2)
                {
                    ...
                    if (IntervalTime > Interval && AddMore == true)
                    {
                        ParticleList.Add(new Particle(Texture, Position, angle, speed, hp, Transparency, Fade, startingRotation,
                            rotation, scale, StartColor, EndColor, Gravity, CanBounce, MaxY, Shrink, DrawDepth, StopBounce));
                        IntervalTime = 0;
                    }
                }
                else
