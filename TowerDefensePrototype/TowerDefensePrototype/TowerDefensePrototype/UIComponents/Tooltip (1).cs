...
namespace TowerDefensePrototype
{
    public class Tooltip
    {
        ...
        public Tooltip(string text, Texture2D boxTexture, SpriteFont font)
        {
            Text = text;
        ...
        public void Update(Vector2 cursorPosition, GameTime gameTime)
        {
            ...
            ActualSize = Vector2.Lerp(ActualSize, new Vector2(Font.MeasureString(Text).X, Font.MeasureString(Text).Y), 0.2f * (float)(gameTime.ElapsedGameTime.TotalSeconds * 60));
        }
