...
namespace TowerDefensePrototype
{
    public class  CannonBall : HeavyProjectile
    {
        public CannonBall(Vector2 position, float speed, float angle, float gravity)
        {
            ...
            Emitter = new Emitter("Smoke", new Vector2(Position.X + 16, Position.Y + 8), new Vector2(90, 180), new Vector2(1.5f, 2), new Vector2(15, 20), 0.2f, true, new Vector2(-20, 20), new Vector2(-4, 4), new Vector2(0.5f, 1f), FireColor, FireColor2, 0.0f, -1, 1, 1, false);         
        }
    }
}
