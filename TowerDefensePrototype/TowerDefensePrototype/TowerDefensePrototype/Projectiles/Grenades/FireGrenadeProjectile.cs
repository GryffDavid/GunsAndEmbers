...
namespace TowerDefensePrototype
{
    ...
    class FireGrenadeProjectile : TimerHeavyProjectile
    {
        public FireGrenadeProjectile(object source, float maxTime, Texture2D texture, Texture2D particleTexture, Vector2 position, 
        ...
        {
            HeavyProjectileType = HeavyProjectileType.FireGrenade;
